            ...
            <div class="box box-primary">
                <div class="box-header  with-border">
                    ...
                    <div class="box-tools pull-right">
                        ...
                        ?>
                        <a href="<?php echo $url; ?>" id="agregarArea" class="btn btn-primary ">
                ...
                <div class="box-body">
                    <div class="form-row">
                        ...
                        <div class="col-sm-12 ">
                            <label for="organismo_id">Palabras Claves: </label>
                            <?php
                    ...
                    <div class="form-group">
                        <div class=" col-sm-12">
                            <a href="#" class="btn btn-primary" onclick="javascript:history.back();">
