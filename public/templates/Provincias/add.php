        ...
        <div class="col-xs-12">
            <div class="box box-primary">
                <div class="box-header  with-border">
                    <h3 class="box-title"> <span class="fa fa-refresh fa-lg"></span> Agregar Provincia</h3>
                ...
                <div class="box-body">
                    <div class="form-row">
                        <form id="ProvinciasAddForm" name="ProvinciasAddForm" role="form" action="/Provincias/add/" method="POST">
