    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <div class="form-row">
                        <form id="ObrasSocialesAddForm" name="ObrasSocialesAddForm" role="form" action="/ObrasSociales/add/" method="POST">
                            ...
                            <div class="form-group col-sm-2">
                                <label >CUIT</label>
                                <input required type="text" maxlength="20" placeholder="Ingrese el cuit"
                            ...
                            <div class="form-group col-sm-6">
                                <label >Email</label>
                                <input type="email" maxlength="255" placeholder="Ingrese la descripción" class="form-control" name="email">
                            ...
                            <div class="form-group col-sm-8">
                                ...
                                <input type="text" maxlength="255" placeholder="Ingrese la dirección"
                            ...
                            <div class="form-group col-sm-4">
                                ...
                                <input type="text" maxlength="20" placeholder="Ingrese el télefono"
