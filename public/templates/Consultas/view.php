                    ...
                    <div class="form-row">
                        <form id="CategoriasAddForm" name="CategoriasAddForm" role="form" action="/Consultas/add/" method="POST">
                            ...
                            <div class="form-group col-sm-2">
                                ...
                                <?php if ($consulta->getError('nombre')) { ?>
                                    <?php foreach ($consulta->getError('nombre') as $error) { ?>
                            ...
                            <div class="form-group col-sm-10">
                                ...
                                <?php if ($consulta->getError('descripcion')) { ?>
                                    <?php foreach ($consulta->getError('descripcion') as $error) { ?>
                                        <span class="badge bg-red"><i class="fa fa-warning"></i> <?php echo $error; ?></span>
                                    <?php } ?>
                                <?php } ?>
