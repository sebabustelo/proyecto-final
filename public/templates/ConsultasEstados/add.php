...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa  fa-dot-circle-o"></i>Estados de consulta</a></li> <i class="fa fa-arrow-right"></i>
        ...
        <div class="col-xs-12">
            <div class="box box-primary">
                <div class="box-header  with-border">
                    <h3 class="box-title"> <span class="fa fa-plus fa-lg"></span> Nueva Estado de Consulta</h3>
                    <div class="box-tools pull-right">
                        <a title="Listado de Estados de consulta" href="/ConsultasEstados/index/" class="btn btn-sm btn-primary ">
                            <span class="fa fa-list"></span>  <span class="hidden-xs">Estados de Consulta</span></a>
                        <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
                    </div>
                </div>
                <div class="box-body">
                    <div class="form-row">
                        <form id="EstadosAddForm" name="EstadosAddForm" role="form" action="/ConsultasEstados/add/" method="POST">
                            ...
                            if ($this->request->getSession()->check('previousUrl')) {
                                ...
                                if (strpos($url, "ConsultasEstados") !== false) {
                                    $url = $this->request->getSession()->read('previousUrl');
                                } else {
                                    $url = "/ConsultasEstados/index/";
                                }
                            } else {
                                $url = '/ConsultasEstados/index';
                            }
