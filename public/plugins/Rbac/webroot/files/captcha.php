...
session_start(); //se carga por separado
...
{
	case 1:
		define("F_FONT", "captcha/myfont.ttf");
		break;
	case 2:
		define("F_FONT", "captcha/myfont2.ttf");
		break;
	case 3:
		define("F_FONT", "captcha/myfont3.ttf");
		break;
	case 4:
		define("F_FONT", "captcha/myfont4.ttf");
		break;
}
...
{
	case 1:
		$img_copy = imagecreatefrompng("captcha/captcha.png");
		break;
	case 2:
		$img_copy = imagecreatefrompng("captcha/captcha2.png");
		break;
	case 3:
		$img_copy = imagecreatefrompng("captcha/captcha3.png");
		break;
	case 4:
		$img_copy = imagecreatefrompng("captcha/captcha4.png");
		break;
	case 5:
		$img_copy = imagecreatefrompng("captcha/captcha5.png");
		break;
	case 6:
		$img_copy = imagecreatefrompng("captcha/captcha6.png");
		break;
	case 7:
		$img_copy = imagecreatefrompng("captcha/captcha7.png");
		break;
	case 8:
		$img_copy = imagecreatefrompng("captcha/captcha8.png");
		break;
	case 9:
		$img_copy = imagecreatefrompng("captcha/captcha9.png");
		break;
}
