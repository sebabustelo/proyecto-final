        ...
        <div class="col-xs-12">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <form id="RbacPerfilesEditForm" name="RbacPerfilesEditForm" role="form" action="/rbac/RbacPerfiles/edit/<?php echo $rbacPerfil->id; ?>" method="POST">
                        ...
                        <div class="form-group " id="dual-list">
    ...
    $(function() {
        ...
        var RbacAcciones = $('#rbac-acciones-ids')
            .bootstrapDualListbox({
                ...
                removeAllLabel: 'Remover todas las acciones',
                moveSelectedLabel: 'Asignar seleccionada',
                removeSelectedLabel: 'Remover acción seleccionada',
                ...
                // setMoveAllLabel:'Mover todas las acciones',
