    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <div class="box-body">
                        <form class="form-horizontal" id="ConfiguracionesEditForm" name="ConfiguracionesEditForm" role="form" action="/rbac/configuraciones/edit/<?php echo $configuracion->id; ?>" method="POST">
