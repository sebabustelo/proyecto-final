...
CREATE TABLE `consultas` (
  ...
  CONSTRAINT `fk_consulta_estado_id` FOREIGN KEY (`consulta_estado_id`) REFERENCES `consultas_estados` (`id`) ON UPDATE NO ACTION,
...
INSERT INTO `consultas` VALUES (7,5,9,9,'test','test',NULL,NULL);
...
INSERT INTO `detalles_pedidos` VALUES (25,33,39,1),(26,34,36,1),(27,35,39,1);
...
INSERT INTO `direcciones` VALUES (24,'terrero',1589,'2','31',296,NULL),(35,'padilla',752,'2','a',296,NULL),(36,'padilla',752,'2','a',282,NULL),(37,'Padilla',752,'11','E',317,NULL),(44,'Padilla',752,'11','E',317,NULL),(45,'padilla',752,'2','a',282,NULL),(46,'padilla',752,'2','a',282,NULL),(47,'padilla',752,'2','a',296,NULL);
...
INSERT INTO `ordenes_medicas` VALUES (25,33,'0','1728625672_orden_medica_sebastian_bustelo.pdf','pdf',1993,'D:\\sitios\\ipmagna\\public\\webroot\\uploads/ordenes_medicas/1728625672_orden_medica_sebastian_bustelo.pdf','2024-10-11 07:47:52','2024-10-11 07:47:52'),(26,34,'0','1728627564_orden_medica_sebastian_bustelo.pdf','pdf',1993,'D:\\sitios\\ipmagna\\public\\webroot\\uploads/ordenes_medicas/1728627564_orden_medica_sebastian_bustelo.pdf','2024-10-11 08:19:24','2024-10-11 08:19:24'),(27,35,'0','1731130976_orden_medica_sebastian_bustelo.pdf','pdf',1993,'D:\\sitios\\ipmagna\\public\\webroot\\uploads/ordenes_medicas/1731130976_orden_medica_sebastian_bustelo.pdf','2024-11-09 06:42:56','2024-11-09 06:42:56');
...
CREATE TABLE `pedidos` (
  ...
  KEY `fk_direccion_idx` (`direccion_id`),
...
INSERT INTO `pedidos` VALUES (33,10,2,45,'2024-10-11 07:47:51','2024-10-17','necesito urgente','2024-10-11 07:47:52','2024-10-11 04:29:35'),(34,10,6,46,'2024-10-11 08:19:24','2024-10-30','urgente','2024-10-11 08:19:24','2024-10-26 13:55:11'),(35,10,2,47,'2024-11-09 06:42:56','2024-11-11','test','2024-11-09 06:42:56','2024-11-09 06:42:56');
...
INSERT INTO `productos` VALUES (34,'FIN SHORT ',9,1,'El tallo corto recto FIN SHORT ofrece una alternativa a las técnicas de revestimiento femoral, manteniendo las características propias de estabilidad que han diferenciado al vástago FIN durante los últimos 30 años.','El vástago FIN SHORT ofrece una alternativa a las técnicas de revestimiento femoral, manteniendo las características propias de estabilidad que han diferenciado al vástago FIN durante los últimos 30 años.',25,'2024-09-13 01:35:12','2024-10-31 21:35:17',1),(35,'K-MONO',7,1,'El sistema K-MONO ofrece un doble enfoque fisiológico para la zona femoral: Resección (3CUT) y Revestimiento (RES), ambos compatibles con el componente tibial anatómico (MetalBack y AllPoly).','El sistema patentado K-MONO es una solución completa y única con un abanico de posibilidades diseñadas para adaptarse al enfoque individual del cirujano para cada paciente.',23,'2024-10-05 15:32:11','2024-10-10 23:00:42',1),(36,'K-MOD',7,1,'K-MOD es el sistema de prótesis primaria total de rodilla que se caracteriza por la modularidad de sus componentes.',NULL,11,'2024-10-05 20:56:49','2024-10-11 08:19:24',1),(37,'K-MOD-REV',7,1,'El sistema de revisión de rodilla K-MOD REV CCK está diseñado para artroplastia total de rodilla primaria y de revisión en caso de inestabilidad o ligamentos colaterales con funcionalidad inadecuada.',NULL,8,'2024-10-05 21:14:16','2024-10-05 21:14:16',1),(38,'K-MOD REV CCK',7,1,'El sistema de revisión de rodilla K-MOD REV CCK está diseñado para artroplastia total de rodilla primaria y de revisión en caso de inestabilidad o ligamentos colaterales con funcionalidad inadecuada.','El sistema de revisión de rodilla K-MOD REV CCK está diseñado para artroplastia total de rodilla primaria y de revisión en caso de inestabilidad o ligamentos colaterales con funcionalidad inadecuada.\r\nEl sistema K-MOD REV CCK es completamente compatible y modular con el sistema K-MOD REV BOXLESS: los objetivos son, de hecho, poder hacer más efectivas las operaciones de revisión, y adaptarse a las diferentes situaciones anatómicas y a las necesidades del cirujano, incluso en casos de ligamentos colaterales dañados.\r\nLa modularidad de K-MOD REV CCK con el sistema K-MODREV BOXLESS permite elegir intraoperatoriamente el grado de constricción más adecuado:\r\n\r\nESTABILIZACIÓN ANTERIOR y POSTERIOR mediante insertos UltraCongruent (UC) o insertos Dynamic Congruence (DC) acoplados al fémur K-MOD REV BOXLESS o insertos de estabilidad posterior PS con el fémur K-MOD REV CCK.\r\nCONSTRICCIÓN en VARO/VALGO y ROTACIÓN FEMOROTIBIAL usando los insertos CCK combinados con el fémur K-MOD REV CC',15,'2024-10-11 07:02:05','2024-10-11 07:02:05',1),(39,'Fassier Duval',6,1,'El sistema intramedular telescópico Fassier-Duval es una varilla autoextensible diseñada para pacientes que padecen osteogénesis imperfecta (OI), displasia esquelética y otras deformidades óseas. Creado para prevenir o estabilizar fracturas o corregir la deformidad de los huesos largos mientras',' El sistema intramedular telescópico Fassier-Duval es una varilla autoextensible diseñada para pacientes que padecen osteogénesis imperfecta (OI), displasia esquelética y otras deformidades óseas. Creado para prevenir o estabilizar fracturas o corregir la deformidad de los huesos largos mientras se produce el crecimiento.\r\n\r\nEl diseño de la varilla incluye un componente hembra (que está unido a la epífisis proximal) y un componente masculino (que está unido a la epífisis distal). Está disponible en cinco diámetros: 3,2, 4,0, 4,8, 5,6 y 6,4 mm, hasta 420 mm de longitud.\r\n\r\nLos Pega PEG permiten el enclavamiento tanto de FD Rod como de SLIM:\r\n\r\nProporciona una mayor fijación en el hueso osteopénico.\r\nReducir el riesgo de migración\r\nTamaño 2.0, 2.4 y 2.8\r\nRango de longitud 16-60 mm',10,'2024-10-11 07:03:43','2024-11-09 06:42:56',1),(40,'Flex +2',3,1,'El sistema Flex +2 es una innovadora varilla estéril diseñada para la estabilización dinámica lumbar degenerativa o el montaje de remate. El Flex +2 es un dispositivo dinámico que se puede implantar ya sea durante un abordaje percutáneo o durante cirugías abiertas.','Sistema de estabilización dinámica.\r\nMantener la altura intervertebral.\r\nEstabilización duradera sin fusión\r\nVarillas dinámicas de perfil bajo patentadas.\r\nPieza dinámica incluida en la varilla de 6 mm de diámetro.\r\nImplantable mediante abordaje percutáneo.\r\nSin pasos quirúrgicos adicionales ni instrumentación específica\r\nAmplia gama de varillas dinámicas o híbridas de Ø 6 mm\r\nVarilla dinámica para 1 nivel en abordaje abierto o percutáneo\r\nVarilla híbrida de uno o dos niveles para completar la construcción.\r\nUn verdadero rango de movimiento dinámico en 3D\r\nPlano frontal y sagital\r\nPlano transversal\r\nSólo debe usarse con los productos SPINEVISION: Lumis, Ulis y Plus.',13,'2024-10-11 07:05:17','2024-10-11 07:05:17',1),(41,'Ulis',3,1,'Ulis es un sistema de tornillos pediculares de carga superior potente e intuitivo especialmente diseñado para simplificar las cirugías abiertas para la columna lumbar degenerativa. El conjunto ergonómico y compacto de Ulis permite a los cirujanos realizar una construcción versátil con una gran varie','Una gama completa para abordar todas las situaciones.\r\nTornillos multiaxiales con movilidad polar de cabeza de 360°\r\nTornillos monobloque para puntos fijos fuertes\r\nTornillos de reducción multiaxiales para facilitar la colocación de la varilla\r\nDiámetros de tornillos de 4,5 mm a 8,5 mm en incrementos de 1 mm\r\nLongitud de 25 a 90 mm en incrementos de 5 mm\r\nGran libertad y rapidez en la colocación de tornillos.\r\nMovilidad polar de 360° de la cabeza del tornillo.\r\n+/- 30° poliaxialidad\r\nImplantes de perfil bajo y liso.\r\nRosca doble para una inserción rápida.\r\nInstrumentación ergonómica y fácil de usar.\r\nReducción simultánea de la varilla e inserción del tornillo de fijación\r\nTornillos codificados por colores para una rápida identificación.\r\nDos tipos de varillas, desde construcciones dinámicas hasta construcciones rígidas.\r\nVarillas rectas o predobladas de aleación de titanio de 6 mm de diámetro\r\nVarilla Flex +2* para montaje dinámico o de remate',16,'2024-10-11 07:06:18','2024-10-11 07:06:18',1),(42,'Lumis',3,1,'Lumis es un versátil sistema de tornillos pediculares poliaxiales de carga superior especialmente diseñado para cirugía mínimamente invasiva. Optimizado y potente, Lumis es totalmente compatible con las varillas Flex +2 para realizar una construcción dinámica o híbrida mediante un abordaje percutáne','Estabilización dinámica incluso en MIS\r\nTotalmente compatible con las cañas Flex +2\r\nVarilla dinámica patentada para ser implantable percutáneamente\r\nColocación de tornillos percutáneos\r\nExtensión de Ø 14,5 mm fácil de usar y segura\r\n+/- 30° poliaxialidad\r\nImplantes de bajo perfil\r\nAmplia gama de implantes\r\nDiámetros de tornillos de 5,5 mm a 8,5 mm en incrementos de 1 mm\r\nLongitud de 30 a 60 mm en incrementos de 5 mm\r\nVarillas de aleación de titanio de 6 mm de diámetro, de 30 mm a 140 mm de longitud\r\nInstrumentación ergonómica y que ahorra tiempo\r\nCarga de extensiones fácil y rápida\r\nRosca doble para una inserción rápida.\r\nTornillos codificados por colores para una rápida identificación.\r\nDos soluciones diferentes para la introducción de varillas\r\n2 tipos de persuasores (de 16 a 33mm de offset)',11,'2024-10-11 07:07:32','2024-10-11 07:07:32',1);
...
CREATE TABLE `productos_archivos` (
  ...
  CONSTRAINT `fk_productos` FOREIGN KEY (`producto_id`) REFERENCES `productos` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `productos_archivos` VALUES (23,34,'1728552705_fin_short.jpg','jpg',21307,'D:\\sitios\\ipmagna\\public\\webroot\\img/productos/1728552705_fin_short.jpg','2024-10-10 11:31:45','2024-10-10 11:31:45',0),(24,35,'1728552720_k-mono.jpg','jpg',21751,'D:\\sitios\\ipmagna\\public\\webroot\\img/productos/1728552720_k-mono.jpg','2024-10-10 11:32:00','2024-10-10 11:32:00',0),(25,36,'1728552736_kmod.jpg','jpg',19396,'D:\\sitios\\ipmagna\\public\\webroot\\img/productos/1728552736_kmod.jpg','2024-10-10 11:32:16','2024-10-10 11:32:16',0),(26,37,'1728552748_kmod-rev.jpg','jpg',19543,'D:\\sitios\\ipmagna\\public\\webroot\\img/productos/1728552748_kmod-rev.jpg','2024-10-10 11:32:28','2024-10-10 11:32:28',0),(27,38,'1728622925_kmod-rev2.jpg','jpg',401336,'D:\\sitios\\ipmagna\\public\\webroot\\img/productos/1728622925_kmod-rev2.jpg','2024-10-11 07:02:05','2024-10-11 07:02:05',1),(28,39,'1728623023_fassier-duval.jpg','jpg',333852,'D:\\sitios\\ipmagna\\public\\webroot\\img/productos/1728623023_fassier-duval.jpg','2024-10-11 07:03:43','2024-10-11 07:03:43',1),(29,40,'1728623117_flex.jpg','jpg',336369,'D:\\sitios\\ipmagna\\public\\webroot\\img/productos/1728623117_flex.jpg','2024-10-11 07:05:17','2024-10-11 07:05:17',1),(30,41,'1728623178_ulis_640x640.jpg','jpg',36958,'D:\\sitios\\ipmagna\\public\\webroot\\img/productos/1728623178_ulis_640x640.jpg','2024-10-11 07:06:18','2024-10-11 07:06:18',1),(31,42,'1728623252_lumis.jpg','jpg',633032,'D:\\sitios\\ipmagna\\public\\webroot\\img/productos/1728623252_lumis.jpg','2024-10-11 07:07:32','2024-10-11 07:07:32',1);
...
CREATE TABLE `productos_precios` (
  ...
  CONSTRAINT `fk_producto` FOREIGN KEY (`producto_id`) REFERENCES `productos` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `productos_precios` VALUES (2,34,400000.00,'2024-10-03 14:30:53','2024-10-04 19:05:14'),(7,34,500000.00,'2024-10-04 19:05:14','2024-10-09 01:34:24'),(8,35,780000.00,'2024-10-05 11:48:15',NULL),(9,36,680000.00,'2024-10-05 20:56:49',NULL),(10,37,950000.00,'2024-10-05 21:14:16',NULL),(11,34,600000.00,'2024-10-09 01:34:24',NULL),(12,38,1200000.00,'2024-10-11 07:02:05',NULL),(13,39,890000.00,'2024-10-11 07:03:43','2024-10-31 14:58:04'),(14,40,420000.00,'2024-10-11 07:05:17',NULL),(15,41,390000.00,'2024-10-11 07:06:18',NULL),(16,42,395000.00,'2024-10-11 07:07:32',NULL),(17,39,50000.00,'2024-10-31 14:58:04',NULL);
...
INSERT INTO `proveedores` VALUES (1,'DIRT','test',45,432432,'seba@f.com','20289991868','2024-09-09 16:42:10','2024-10-20 12:40:32',1),(2,'PVE','sdfsf',46,1140876458,'sebabustelo@gmail.com','20289991868','2024-09-14 03:16:53','2024-11-01 17:45:29',1);
...
) ENGINE=InnoDB AUTO_INCREMENT=3611 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `rbac_acciones_rbac_perfiles` VALUES (3071,27,1),(3095,5,1),(3102,16,1),(3103,2,1),(3106,1,1),(3107,3,1),(3156,17,1),(3278,114,1),(3328,151,1),(3331,154,1),(3457,10,1),(3464,250,1),(3465,17,8),(3466,114,8),(3468,124,8),(3470,12,1),(3471,251,1),(3472,252,1),(3477,257,1),(3478,258,1),(3479,259,1),(3480,260,1),(3481,261,1),(3482,262,1),(3483,263,1),(3484,264,1),(3486,266,1),(3487,267,1),(3488,268,1),(3489,269,1),(3490,270,1),(3491,271,1),(3497,277,1),(3498,278,1),(3499,279,1),(3500,280,1),(3501,281,1),(3502,282,1),(3503,283,1),(3504,284,1),(3509,289,1),(3510,290,1),(3512,292,1),(3515,293,1),(3516,294,1),(3517,295,1),(3518,296,1),(3519,297,1),(3520,298,1),(3523,302,1),(3527,263,8),(3528,268,8),(3531,303,1),(3532,304,1),(3533,305,1),(3538,310,1),(3539,311,1),(3540,312,1),(3541,313,1),(3549,321,1),(3550,322,1),(3551,323,1),(3552,324,1),(3553,325,1),(3554,326,1),(3555,327,1),(3556,328,1),(3557,329,1),(3558,330,1),(3560,251,8),(3573,332,1),(3574,292,8),(3575,332,8),(3576,334,1),(3577,334,8),(3578,335,1),(3581,338,1),(3582,335,8),(3583,338,8),(3584,339,1),(3585,340,1),(3586,341,1),(3587,342,1),(3588,342,8),(3589,343,8),(3590,343,1),(3591,1,9),(3592,3,9),(3593,254,9),(3594,258,9),(3595,271,9),(3596,305,9),(3597,323,9),(3598,324,9),(3599,339,9),(3600,339,10),(3601,341,10),(3602,339,11),(3603,339,12),(3604,339,13),(3605,344,1),(3607,347,1),(3608,348,8),(3609,348,1),(3610,349,1);
...
INSERT INTO `rbac_token` VALUES (85,10,'BPbitdN9HvLi8smRg2xI9gxv','2024-10-11 09:06:18','2024-10-11 09:06:18',1440),(86,10,'5sE0q1c-UEIm2IVF9ss7ewj_','2024-10-11 09:07:19','2024-10-11 09:07:19',1440),(87,10,'mPLoddiczGBY0O_1Im6QTUJf','2024-10-11 09:09:56','2024-10-11 09:09:56',1440);
...
CREATE TABLE `rbac_usuarios` (
  ...
  KEY `FK_direcciones_idx` (`direccion_id`),
  CONSTRAINT `FK_direcciones` FOREIGN KEY (`direccion_id`) REFERENCES `direcciones` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `rbac_usuarios` VALUES (9,1,24,'florencia','florenciatigani@hotmail.com','María Florencia','Tigani',1,'30999121',NULL,NULL,NULL,'33a47f95b1fca05597aec141e7a3221e90a20dac6e73c3e38b09931229212713','d57edf2d2082b0865e15d11edaecdb20',1,'2019-10-28 14:50:04','2024-08-30 18:01:45',NULL,'2923'),(10,1,35,'sebabustelo','sebabustelo@gmail.com','Sebastian','Bustelo',1,'28999186',NULL,NULL,1140876451,'d685328db63350ce310941e16d676d09b88bd3e8630c334a883edf0ee0f8d4fa','07a500b0097c2725b5ee843d28259d8456e320f9e71bb70e1370e4de3671dc92',1,'2024-08-30 14:29:31','2024-11-02 23:23:08','2907','2907'),(11,1,36,'facundo','faquundo2406@hotmail.com','Facundo','Ramirez',1,'37680252',NULL,NULL,1128809967,'9f4dbfaa3036cd2b07d9613fb0af7f8033dfcb314ab4115607e799454e8dc709','07a500b0097c2725b5ee843d28259d8456e320f9e71bb70e1370e4de3671dc92',1,'2024-09-28 10:52:31','2024-09-28 11:00:06',NULL,NULL),(13,8,24,'Juan','eduardotigani@hotmail.com','Juan','Perez',1,'8432465',NULL,NULL,548285215,'bf337535d1ebf9b2622e10d9129fb7b00596773df7d3dda890b7a70896a80e25','07a500b0097c2725b5ee843d28259d8456e320f9e71bb70e1370e4de3671dc92',1,'2024-10-03 20:40:40','2024-10-03 20:44:19',NULL,NULL),(15,8,24,'pepito','mviapiano@esbabarrionorte.edu.ar','Maximliano Hernán','Viapiano123',1,'dddd',NULL,'',1151655284,'1c0ab00ae04218154fcb86f24f9274c6d9a1f1da20875ba2ff7e2c8d816b7263','07a500b0097c2725b5ee843d28259d8456e320f9e71bb70e1370e4de3671dc92',1,'2024-10-04 08:44:59','2024-10-04 08:51:03',NULL,'2923');
...
INSERT INTO `tipo_documentos` VALUES (1,'DNI','2024-09-04 20:48:19','2024-09-04 20:52:56',1),(2,'LE','2024-09-04 20:48:19','2024-09-04 20:52:56',1),(3,'PASAPORTE','2024-09-04 20:48:19','2024-09-04 20:52:56',1),(4,'CUIT','2024-10-04 03:21:22','2024-10-22 06:45:39',1);
...
-- Dump completed on 2024-11-09  2:50:25
