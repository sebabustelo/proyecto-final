...
INSERT INTO `consultas` VALUES (7,5,9,9,'test','test',NULL,NULL),(8,6,10,10,'test','test','2024-11-15 15:03:01','2024-11-15 15:15:42');
...
INSERT INTO `detalles_pedidos` VALUES (25,33,39,1),(26,34,36,1),(27,35,39,1),(28,38,42,1),(29,39,34,1);
...
INSERT INTO `direcciones` VALUES (24,'terrero',1589,'2','31',296,NULL),(35,'Juan A Garcia',1854,'10','a',296,NULL),(36,'padilla',752,'2','a',282,NULL),(37,'Padilla',752,'11','E',317,NULL),(44,'Padilla',752,'11','E',317,NULL),(45,'padilla',752,'2','a',282,NULL),(46,'padilla',752,'2','a',282,NULL),(47,'padilla',752,'2','a',296,NULL),(50,'padilla',752,'75','a',296,NULL),(51,'pringles',836,'5','E',283,NULL),(52,'Juan A Garcia',1854,'10','a',296,NULL),(53,'Tinogasta',1854,'1','4',289,NULL),(54,'Tinogasta',1854,'1','4',289,NULL),(59,'Agustn Garcia',1854,'','3',18,NULL),(60,'Agustn Garca',1854,'','Agu',495,NULL),(61,'Agustn Garca',1854,'','Agu',1,NULL),(62,'Agustn Garca',1854,'','Agu',345,NULL);
...
CREATE TABLE `proveedores` (
  ...
  CONSTRAINT `fk_proveedores_direccion` FOREIGN KEY (`direccion_id`) REFERENCES `direcciones` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `proveedores` VALUES (1,'DIRT','test',45,432432,'seba@f.com','20289991868','2024-09-09 16:42:10','2024-10-20 12:40:32',1),(2,'PVE','sdfsf',46,1140876458,'zebabustelo@gmail.com','20289991868','2024-09-14 03:16:53','2024-11-15 14:39:56',1),(6,'seba','test',51,1140876458,'wsb@mrecic.gob.ar','27280335148','2024-11-16 06:10:32','2024-11-16 06:10:32',1);
...
INSERT INTO `rbac_token` VALUES (85,10,'BPbitdN9HvLi8smRg2xI9gxv','2024-10-11 09:06:18','2024-10-11 09:06:18',1440),(86,10,'5sE0q1c-UEIm2IVF9ss7ewj_','2024-10-11 09:07:19','2024-10-11 09:07:19',1440),(87,10,'mPLoddiczGBY0O_1Im6QTUJf','2024-10-11 09:09:56','2024-10-11 09:09:56',1440),(90,10,'38--PXUWA7gYsvkwL8BgTF5UTQd','2024-11-15 12:45:10','2024-11-15 12:45:10',1440),(91,10,'35-p4PZToggNnSpaO82500hRsKp','2024-11-15 13:56:55','2024-11-15 13:56:55',1440),(92,10,'38-KZv6KOvbvv6dU13LoY3z_g-L','2024-11-15 14:05:40','2024-11-15 14:05:40',1440);
...
INSERT INTO `rbac_usuarios` VALUES (9,1,24,'florencia','florenciatigani@hotmail.com','María Florencia','Tigani',1,'30999121',NULL,NULL,NULL,'33a47f95b1fca05597aec141e7a3221e90a20dac6e73c3e38b09931229212713','d57edf2d2082b0865e15d11edaecdb20',1,'2019-10-28 14:50:04','2024-08-30 18:01:45',NULL,'2923'),(10,1,35,'sebabustelo','sebabustelo@gmail.com','Sebastian','Bustelo',1,'28999186',NULL,NULL,1140876451,'d685328db63350ce310941e16d676d09b88bd3e8630c334a883edf0ee0f8d4fa','07a500b0097c2725b5ee843d28259d8456e320f9e71bb70e1370e4de3671dc92',1,'2024-10-30 14:29:31','2024-11-21 18:53:15','2907','2907'),(11,1,36,'facundo','faquundo2406@hotmail.com','Facundo','Ramirez',1,'37680252',NULL,NULL,1128809967,'9f4dbfaa3036cd2b07d9613fb0af7f8033dfcb314ab4115607e799454e8dc709','07a500b0097c2725b5ee843d28259d8456e320f9e71bb70e1370e4de3671dc92',1,'2024-09-28 10:52:31','2024-09-28 11:00:06',NULL,NULL),(15,1,24,'pepito','mviapiano@esbabarrionorte.edu.ar','Maximliano Hernán','Viapiano123',1,'dddd',NULL,'',1151655284,'1c0ab00ae04218154fcb86f24f9274c6d9a1f1da20875ba2ff7e2c8d816b7263','07a500b0097c2725b5ee843d28259d8456e320f9e71bb70e1370e4de3671dc92',1,'2024-11-04 08:44:59','2024-12-15 18:12:41',NULL,'2923'),(50,8,62,'zeba','zebabustelo@gmail.com','Walter Sebastian','Bustelo',1,'32432',NULL,'',34243,'d685328db63350ce310941e16d676d09b88bd3e8630c334a883edf0ee0f8d4fa','07a500b0097c2725b5ee843d28259d8456e320f9e71bb70e1370e4de3671dc92',1,'2024-12-18 11:32:06','2024-12-18 11:32:34',NULL,NULL);
...
-- Dump completed on 2024-12-19 12:57:56
-- MySQL dump 10.13  Distrib 8.0.38, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: ipmagna_test
-- ------------------------------------------------------
-- Server version	5.5.5-10.4.32-MariaDB
...
CREATE TABLE `pedidos` (
  ...
  CONSTRAINT `fk_cliente` FOREIGN KEY (`cliente_id`) REFERENCES `rbac_usuarios` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_direccion` FOREIGN KEY (`direccion_id`) REFERENCES `direcciones` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_estado` FOREIGN KEY (`estado_id`) REFERENCES `pedidos_estados` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-12-19 12:57:57
