...
-- Volcando datos para la tabla ipmagna.kit_cirugias: ~3 rows (aproximadamente)
...
-- Volcando datos para la tabla ipmagna.productos_archivos: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla ipmagna.rbac_acciones: ~70 rows (aproximadamente)
