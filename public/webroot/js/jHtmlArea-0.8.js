    ...
    jHtmlArea.fn = jHtmlArea.prototype = {
        ...
        init: function (elem, options) {
            if (elem.nodeName.toLowerCase() === "textarea") {
                ...
                iframe.width(textarea.width()+20);
        ...
        signo: function() {
        	//this.editor.body.innerHTML = this.textarea.val()+'<div class="cuadro_signo"></div>';
        	var s = this.getSelectedHTML();
        	if (s) {
	            s = '<div class="cuadro_signo">' + s + '</div>';
	            this.pasteHTML(s);
        	}
        },
        estrella: function() {
        	...
        	var s = this.getSelectedHTML();
        	if (s) {
            	s = '<div class="cuadro_leyenda">' + s + '</div>';
            	this.pasteHTML(s);
        	}
        },
        texto: function() {
        ...
        c_haya: function() {
        	this.html(this.html()+'<div class="conv_haya"></div>');
        },
        indent: function () {
            this.ec("indent");
        },
