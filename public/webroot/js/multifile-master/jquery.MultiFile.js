			...
			.each(function () {
				...
				MultiFile.addToList = function (slave, slave_count, files) {
								...
								label =	$(
										(
											'<span class="MultiFile-label" title="' + t + '">'+
												'<span class="MultiFile-title" style="font-weight: bold;font-style: italic;">'+ n +'</span>'+
					...
					//$.each(files, function (i, file) {
						...
						var
							r = $('<div class="MultiFile-label " style="margin-top:5px;margin-right:2px;text-align:left;margin-top:15px"></div>'),
							b = $('<a class="MultiFile-remove  btn-sm btn-danger  " href="#' + MultiFile.wrapID + '"><span class="glyphicon glyphicon-remove" ></span</a>')
